...
# 🔑 add this ONE line to disable update prompts
...
arima_data_long %>%
  ...
  plot_time_series(
    ...
    .interactive = FALSE,
    .smooth      = FALSE,
    .title       = "Closing Prices of Major Canadian Banks (2005–2023)",
    .y_lab       = "Closing Price"
  )
...
The rsq metric for the fit of the arima model to the testing data is: 0.78❓
:::
...
1.  Regressions that appear to lead to unbiased estimates of the causal effect are: lin_YV❓

2.  Valid adjustment sets for the data used in this question are: {V}❓
:::
